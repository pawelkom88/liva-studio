        ...
        <div className="grid gap-6 row-gap-10 lg:grid-cols-2">
          ...
          <div className="relative sm:h-96 my-auto">
            <Image
              ...
              placeholder="blur"
              blurDataURL="https://scontent.flhr6-1.fna.fbcdn.net/v/t39.30808-6/307855548_1781718195505105_1978558523649562732_n.jpg?_nc_cat=103&ccb=1-7&_nc_sid=730e14&_nc_ohc=MuVOoLk9yKYAX_dcWE5&_nc_ht=scontent.flhr6-1.fna&oh=00_AfAYLO1aG1-HioSq-AixQZS_x71oSd8Tmcqdm9gRdYy4pw&oe=63A1E220"
              alt="faq image"
            />
          </div>
        </div>
