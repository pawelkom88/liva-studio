      ...
      <div className="px-4 py-8 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="grid gap-10 lg:gap-40 lg:grid-cols-2">
          <div className="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg order-2">
            <div className="max-w-xl mb-6 text-right">
              ...
              <p className="text-base large:text-left md:text-lg">
          ...
          <div className="flex-center">
            <div className="flex flex-col items-end ">
              <Image
                width={160}
                height={192}
                className="relative -mr-8 object-cover mb-6 rounded shadow-lg h-48 xl:h-56 w-48 xl:w-56 z-10"
              ...
              <Image
                width={128}
                height={128}
                className="-mr-6 object-cover  rounded shadow-lg h-32 xl:h-40 w-32 xl:w-40"
            ...
            <Image
              width={256}
              height={256}
              className="object-cover rounded shadow-lg h-64 xl:h-80 w-64 xl:w-80"
